...
public class DigitRecognizingNeuralNetwork {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < DigitImageReader.ROWS * DigitImageReader.COLUMNS; i++) {
        ...
        long numberOfHiddenNeurons = Math.round((2.0 / 3.0) * (DigitImageReader.ROWS * DigitImageReader.COLUMNS) + 10);
        ...
        Backpropagator backpropagator = new Backpropagator(neuralNetwork, 0.1, 0.5);
